            ...
            <div className="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-lg border shadow-md dark:bg-gray-800">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="mt-6">
                    ...
                    <div className="mt-4">
                        ...
                        <input  {...register("password", { required: true })} placeholder='Type your password' name="password" id="password" type="password" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>
